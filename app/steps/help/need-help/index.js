...
module.exports = class NeedHelpWithFees extends ValidationStep {
  ...
  interceptor(ctx, session) {
    ctx.feeToBePaid = parseBool(config.features.release520) && session.previousCaseId ? config.commonProps.amendFee.amount : config.commonProps.applicationFee.amount;
    return ctx;
  }
