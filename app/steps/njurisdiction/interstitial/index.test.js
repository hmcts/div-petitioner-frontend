...
const modulePath = 'app/steps/njurisdiction/interstitial';
  ...
  describe('JurisdictionInterstitial routing for connection F when < 12 months resident', () => {
    ...
    beforeEach(done => {
      session = {
        ...
        jurisdictionPath: ['JurisdictionHabitualResidence', 'JurisdictionLastTwelveMonths', 'JurisdictionNDomicile']
      };
      withSession(done, agent, session);
    });
  ...
  describe('JurisdictionInterstitial routing for connection F when > 12 months resident', () => {
    ...
    beforeEach(done => {
      session = {
        ...
        jurisdictionPath: ['JurisdictionHabitualResidence', 'JurisdictionNDomicile']
      };
      withSession(done, agent, session);
    });
  ...
  describe('JurisdictionInterstitial routing for connection E', () => {
    ...
    beforeEach(done => {
      session = {
        divorceWho: 'wife',
        jurisdictionConnection: ['E'],
        jurisdictionPath: ['JurisdictionHabitualResidence', 'JurisdictionLastTwelveMonths', 'JurisdictionNDomicile', 'JurisdictionLastSixMonths']
      };
      withSession(done, agent, session);
    });
