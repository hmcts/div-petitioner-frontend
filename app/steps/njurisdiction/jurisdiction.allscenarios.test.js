...
const pages = [
  {
    uri: '/njurisdiction/habitual-residence',
    branches: [
      {
...
const nextPage = (uri, oldAgent, path, theCallback) => {
  ...
  if (toManyRepeats || uri === '/exit/njurisdiction/no-cnnections' || uri === '/petitioner-respondent/confidential') {
