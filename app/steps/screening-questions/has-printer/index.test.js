...
const modulePath = 'app/steps/screening-questions/has-printer';
...
describe(modulePath, () => {
  beforeEach(() => {
    ...
    underTest = s.steps.ScreeningQuestionsPrinter;
  });
  ...
  describe('success', () => {
    ...
    it('redirects to the next page', done => {
      const context = { screenHasPrinter: 'Yes' };
    ...
    it('redirects to the exit page', done => {
      const context = { screenHasPrinter: 'No' };
