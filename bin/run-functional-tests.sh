...
export COURT_PHONENUMBER_EN=${COURT_PHONENUMBER:-"0300 303 0642"}
export COURT_PHONENUMBER_CY=${COURT_PHONENUMBER:-"0300 303 0642"}
export COURT_OPENINGHOURS_EN=${COURT_OPENINGHOURS:-"Monday to Friday, 8am to 8pm, Saturday 8am to 2pm"}
export COURT_OPENINGHOURS_CY=${COURT_OPENINGHOURS:-"Dydd Llun i ddydd Gwener, 8am i 8pm, dydd Sadwrn 8am i 2pm"}
