...
module "frontend" {
  ...
  app_settings = {
    ...
    COURT_SERVICE_CENTRE_NAME_EN         = "${var.court_service_centre_name_en}"
    COURT_SERVICE_CENTRE_NAME_CY         = "${var.court_service_centre_name_cy}"
    COURT_SERVICE_CENTRE_CITY_EN         = "${var.court_service_centre_city_en}"
    COURT_SERVICE_CENTRE_CITY_CY         = "${var.court_service_centre_city_cy}"
    COURT_SERVICE_CENTRE_POBOX_EN        = "${var.court_service_centre_pobox_en}"
    COURT_SERVICE_CENTRE_POBOX_CY        = "${var.court_service_centre_pobox_cy}"
    COURT_SERVICE_CENTRE_POSTCODE_EN     = "${var.court_service_centre_postcode_en}"
    COURT_SERVICE_CENTRE_POSTCODE_CY     = "${var.court_service_centre_postcode_cy}"
    COURT_SERVICE_CENTRE_EMAIL_EN        = "${var.court_service_centre_email_en}"
    COURT_SERVICE_CENTRE_EMAIL_CY        = "${var.court_service_centre_email_cy}"
    COURT_SERVICE_CENTRE_OPENINGHOURS_EN = "${var.court_service_centre_opening_hours_en}"
    COURT_SERVICE_CENTRE_OPENINGHOURS_CY = "${var.court_service_centre_opening_hours_cy}"
    COURT_SERVICE_CENTRE_PHONENUMBER_EN  = "${var.court_service_centre_phone_number_en}"
    COURT_SERVICE_CENTRE_PHONENUMBER_CY  = "${var.court_service_centre_phone_number_cy}"
