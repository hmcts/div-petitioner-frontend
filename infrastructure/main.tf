...
locals {
  ...
  case_progression_service_url       = "${var.case_progression_service_url == "" ? "http://div-cos-${local.local_env}.service.core-compute-${local.local_env}.internal" : var.case_progression_service_url}"
