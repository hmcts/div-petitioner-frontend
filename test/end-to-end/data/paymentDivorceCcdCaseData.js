module.exports = {
  ...
  created_date: '2018-07-24T14:27:06.906',
  last_modified: '2018-07-24T14:27:40.557',
  security_classification: 'PUBLIC',
  case_data: {
    D8DerivedRespondentHomeAddress: '80 Landor Road\nLondon\nSW9 9PE',
    D8PetitionerNameChangedHow: [
      'marriageCertificate'
    ],
    D8DerivedPetitionerHomeAddress: '80 Landor Road\nLondon\nSW9 9PE',
    ...
    Payments: [
      {
        id: '99999999',
        value: {
          PaymentDate: '2018-07-24',
          PaymentFeeId: 'FEE0002',
          PaymentAmount: '55000',
          PaymentSiteId: 'AA00',
          PaymentStatus: 'Success',
          PaymentChannel: 'online',
          PaymentReference: '99999999',
    ...
    D8PetitionerEmail: 'simulate-delivered-7545005873425666@notifications.service.gov.uk',
    D8ReasonForDivorceBehaviourDetails: 'My wife is having an affair this week.',
    D8ReasonForDivorceClaiming5YearSeparatio: 'NO',
    D8DivorceUnit: 'southWest',
    D8ReasonForDivorceShowDesertion: 'YES',
    D8DerivedRespondentCorrespondenceAddr: '80 Landor Road\nLondon\nSW9 9PE',
    ...
    D8DocumentsUploaded: [],
    D8DerivedPetitionerCorrespondenceAddr: '80 Landor Road\nLondon\nSW9 9PE',
  ...
  data_classification: {
    ...
    D8PetitionerNameChangedHow: 'PUBLIC',
    D8DerivedPetitionerHomeAddress: 'PUBLIC',
    D8RespondentHomeAddress: {
      value: {
        PostCode: 'PUBLIC'
      },
    ...
    D8ScreenHasRespondentAddress: 'PUBLIC',
    D8DivorceCostsClaim: 'PUBLIC',
    Payments: {
      value: [
        {
          id: '99999999',
          value: {
            ...
            PaymentSiteId: 'PUBLIC',
            PaymentStatus: 'PUBLIC',
            PaymentChannel: 'PUBLIC',
            PaymentReference: 'PUBLIC',
            PaymentTransactionId: 'PUBLIC'
          }
        }
      ],
      classification: 'PUBLIC'
    },
    D8ScreenHasMarriageCert: 'PUBLIC',
    D8PetitionerHomeAddress: {
      value: {
        PostCode: 'PUBLIC'
      },
    ...
    D8DivorceClaimFrom: 'PUBLIC',
    D8ScreenHasMarriageBroken: 'PUBLIC',
    D8InferredRespondentGender: 'PUBLIC',
    D8ReasonForDivorceEnableAdultery: 'PUBLIC',
    D8ReasonForDivorceShowAdultery: 'PUBLIC',
    D8DerivedStatementOfCase: 'PUBLIC',
    D8LivingArrangementsLiveTogether: 'PUBLIC',
    D8ReasonForDivorceHasMarriage: 'PUBLIC',
    D8JurisdictionConfidentLegal: 'PUBLIC',
    D8RespondentCorrespondenceUseHomeAddress: 'PUBLIC',
    D8FinancialOrderFor: 'PUBLIC',
    D8Connections: {
      value: {
        A: 'PUBLIC',
        C: 'PUBLIC'
    ...
    D8RespondentLastName: 'PUBLIC',
    D8PetitionerNameDifferentToMarriageCert: 'PUBLIC',
    D8JurisdictionConnection: 'PUBLIC',
    D8LegalProceedingsRelated: 'PUBLIC',
    D8LegalProceedingsDetails: 'PUBLIC',
    D8PetitionerLastName: 'PUBLIC',
    D8ReasonForDivorceAdulteryIsNamed: 'PUBLIC',
    D8PetitionerPhoneNumber: 'PUBLIC',
    D8ClaimsCostsAppliedForFees: 'PUBLIC',
    D8ReasonForDivorceShowTwoYearsSeparation: 'PUBLIC',
    D8StatementOfTruth: 'PUBLIC',
    D8PetitionerCorrespondenceUseHomeAddress: 'PUBLIC',
    D8DerivedRespondentCurrentName: 'PUBLIC',
    D8ReasonForDivorceLimitReasons: 'PUBLIC',
    D8PetitionerEmail: 'PUBLIC',
    D8ReasonForDivorceBehaviourDetails: 'PUBLIC',
    D8ReasonForDivorceClaiming5YearSeparatio: 'PUBLIC',
    D8DivorceUnit: 'PUBLIC',
    D8ReasonForDivorceShowDesertion: 'PUBLIC',
    D8DerivedRespondentCorrespondenceAddr: 'PUBLIC',
    D8MarriagePetitionerName: 'PUBLIC',
    D8Cohort: 'PUBLIC',
    D8MarriageIsSameSexCouple: 'PUBLIC',
    D8FinancialOrder: 'PUBLIC',
    D8ReasonForDivorceShowFiveYearsSeparatio: 'PUBLIC',
    D8MarriageDate: 'PUBLIC',
    D8HelpWithFeesNeedHelp: 'PUBLIC',
    D8JurisdictionRespondentResidence: 'PUBLIC',
    D8DivorceWho: 'PUBLIC',
    D8MarriageCanDivorce: 'PUBLIC',
    D8RespondentFirstName: 'PUBLIC',
    D8ReasonForDivorceShowUnreasonableBehavi: 'PUBLIC',
    D8DocumentsUploaded: {
      value: [],
      classification: 'PUBLIC'
    },
    D8DerivedPetitionerCorrespondenceAddr: 'PUBLIC',
    D8JurisdictionPetitionerResidence: 'PUBLIC',
    D8ReasonForDivorceClaimingAdultery: 'PUBLIC',
    D8MarriedInUk: 'PUBLIC',
    D8PetitionerFirstName: 'PUBLIC',
    D8MarriageRespondentName: 'PUBLIC',
    D8PetitionerContactDetailsConfidential: 'PUBLIC',
    D8LegalProceedings: 'PUBLIC',
    createdDate: 'PUBLIC',
    D8RespondentCorrespondenceAddress: {
      value: {
        PostCode: 'PUBLIC'
