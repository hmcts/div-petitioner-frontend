const connectionSummary = require('app/steps/njurisdiction/connection-summary/content.json').resources.en.translation.content;
...
function* checkMyConnectionSummaryIs(...connections) { // eslint-disable-line require-yield 
  ...
  I.seeCurrentUrlEquals('/njurisdiction/connection-summary');
