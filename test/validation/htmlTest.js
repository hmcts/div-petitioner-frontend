...
const keysToIgnore = [
  ...
  'ScreeningQuestionsLanguagePreference',
  ...
  'ApplicationSubmittedAwaitingResponse',
  'AvayaWebchat',
  'ExitMarriageBroken',
  'ContactDivorceTeam',
  'CutOffLandingPage',
  ...
  'ExitJurisdiction',
  'ExitNoConnections',
  'ExitMarriageCertificate',
  'ExitRespondentAddress',
  'ExitMarriageDate',
  'ExitSixMonthRule',
  'FinancialAdvice',
  'AdulterySecondHandInfo',
  'LivedApartSince',
  'RespondentConsent',
  'SeparationDateNew',
  'Index',
  'SentToBailiff',
  'JurisdictionConnectionSummary',
  ...
  'LegalProceedings',
  'LastLivedTogetherAddress',
  'LastLivedTogether',
  'LiveTogether',
  'AboutYourMarriageCertificate',
  'MarriageCertificateNames',
  'MarriageDate',
  'ForeignCertificate',
  'MarriageHusbandOrWife',
  'MarriedInUk',
  'MarriageNames',
  'UploadMarriageCertificate',
  'AwaitingPaymentStatus',
  'PayOnline',
  'PetitionerChangedNamed',
  'PetitionerConfidential',
  'PetitionerContactDetails',
  'PetitionerCorrespondenceAddress',
  'PetitionerCorrespondence',
  'PetitionerHomeAddress',
  'ClaimCosts',
  'PrivacyPolicy',
  'RespondentCorrespondenceAddress',
  'RespondentCorrespondenceSendToSolicitor',
  'RespondentCorrespondenceSolicitorSearch',
  'RespondentCorrespondenceUseHomeAddress',
  'RespondentHomeAddress',
  'RespondentHomeAddressIsKnown',
  'RespondentLivesAtLastAddress',
  'DeleteApplication',
  'ExitRemovedSavedApplication',
  'ExitApplicationSaved',
